...
public class OrdineTestCase extends DBTestCase{
	...
	public void testDoSave() throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("test/ordine/insert_ordine_oracle.xml"));
	...
	public void testDoRetrieveByKey() throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("test/ordine/retrieve_ordine_by_codice_oracle.xml"));
		ITable expectedTable = expectedDataSet.getTable("ordine");
	...
	public void testDoRetrieveByStato() throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("test/ordine/retrieve_ordine_by_stato_oracle.xml"));
		ITable expectedTable = expectedDataSet.getTable("ordine");
	...
	public void testOrdiniUtente() throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("test/ordine/retrieve_ordine_by_utente_oracle.xml"));
		ITable expectedTable = expectedDataSet.getTable("ordine");
	...
	public void testListaOrdini() throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("test/ordine/retrieve_ordini_oracle.xml"));
		ITable expectedTable = expectedDataSet.getTable("ordine");
	...
	public void testAggiorna() throws Exception{
		 IDatabaseConnection connection = getConnection();
	        ...
	        IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("test/ordine/update_ordine_oracle.xml"));
	        ITable expectedTable = expectedDataSet.getTable("ordine");
	...
	public void testAggiornaConsegnato() throws Exception{
		 IDatabaseConnection connection = getConnection();
	        ...
	        IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("test/ordine/update_ordine_consegnato_oracle.xml"));
	        ITable expectedTable = expectedDataSet.getTable("ordine");
