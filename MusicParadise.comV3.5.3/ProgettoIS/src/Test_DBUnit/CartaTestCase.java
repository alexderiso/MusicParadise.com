...
public class CartaTestCase extends DBTestCase{
	...
	public void testDoSave() throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("test/carta/insert_carta_oracle.xml"));
	...
	public void testLeggi()throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("test/carta/retrieve_carta_by_nickname_oracle.xml"));
		ITable expectedTable = expectedDataSet.getTable("carta");
	...
	public void testRimuoviIndirizzo() throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("test/carta/remove_carta_oracle.xml"));
		ITable expectedTable = expectedDataSet.getTable("carta");
