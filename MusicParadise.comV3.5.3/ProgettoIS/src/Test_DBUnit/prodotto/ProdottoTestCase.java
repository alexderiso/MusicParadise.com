...
public class ProdottoTestCase extends DBTestCase{
	...
	public void testDoRetrieveAll() throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("src/Test_DBUnit/prodotto/retrieve_prodottoInCatalogo_oracle.xml"));
	...
	public void testDoSave() throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("src/Test_DBUnit/prodotto/insert_prodottoInCatalogo_oracle.xml"));
		ITable expectedTable = expectedDataSet.getTable("prodottoInCatalogo");
	...
	public void testDoRetrieveByInstruments() throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("src/Test_DBUnit/prodotto/retrieve_prodottoInCatalogo_by_strumento_oracle.xml"));
		ITable expectedTable = expectedDataSet.getTable("prodottoInCatalogo");
	...
	public void testDoRetrieveByKey() throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("src/Test_DBUnit/prodotto/retrieve_prodottoInCatalogo_by_codice_oracle.xml"));
		ITable expectedTable = expectedDataSet.getTable("prodottoInCatalogo");
	...
	public void testDoRetrieveByName() throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("src/Test_DBUnit/prodotto/retrieve_prodottoInCatalogo_by_nome_oracle.xml"));
		ITable expectedTable = expectedDataSet.getTable("prodottoInCatalogo");
	...
	public void testDoRetrieveByMarca() throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("src/Test_DBUnit/prodotto/retrieve_prodottoInCatalogo_by_marca_oracle.xml"));
		ITable expectedTable = expectedDataSet.getTable("prodottoInCatalogo");
	...
	public void testAggiorna() throws Exception{
		 IDatabaseConnection connection = getConnection();
	        ...
	        IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("src/Test_DBUnit/prodotto/update_prodotto_oracle.xml"));
	        ITable expectedTable = expectedDataSet.getTable("prodottoInCatalogo");
	...
	public void testGeneraCodice() throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("src/Test_DBUnit/prodotto/cod_prodotto_oracle.xml"));
