...
public class ProdottoOrdineTestCase extends DBTestCase {
	...
	public void testDoSave() throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("test/prodottoOrdine/insert_prodottoordine_oracle.xml"));
	...
	public void testProdottiOrdine() throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("test/prodottoOrdine/retrieve_prodottoordine_by_ordine_oracle.xml"));
		ITable expectedTable = expectedDataSet.getTable("prodottoordine");
