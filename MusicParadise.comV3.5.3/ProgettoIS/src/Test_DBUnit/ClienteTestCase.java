...
public class ClienteTestCase extends DBTestCase{
	...
	public void testDoSave() throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("test/cliente/insert_cliente_oracle.xml"));
	...
	public void testLeggi() throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("test/cliente/retrieve_cliente_by_nickname&passowrd_oracle.xml"));
		ITable expectedTable = expectedDataSet.getTable("cliente");
