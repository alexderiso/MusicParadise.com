...
public class CarrelloTestCase extends DBTestCase {
	...
	public void testDoSave() throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("test/carrello/insert_carrello_oracle.xml"));
	...
	public void testLeggi() throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("test/carrello/retrieve_carrello_by_nickname_oracle.xml"));
		ITable expectedTable = expectedDataSet.getTable("incarrello");
	...
	public void testRemove() throws Exception{
		...
		IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(new File("test/carrello/remove_carrello_oracle.xml"));
		ITable expectedTable = expectedDataSet.getTable("incarrello");
