package Test_Selenium.checkout;
...
public class TC_6_1_3 {
  ...
  @Test
  public void testTC613() throws Exception {
    ...
    driver.findElement(By.id("iconCartNum")).click();
    driver.findElement(By.linkText("Checkout")).click();
    driver.findElement(By.cssSelector("button.btn.btn-primary")).click();
    driver.findElement(By.linkText("vai alla home")).click();
  }
