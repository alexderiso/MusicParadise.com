...
public class TC_4_1_8 {
  ...
  @Test
  public void testTC418() throws Exception {
    ...
    driver.findElement(By.cssSelector("div.col-xs-12")).click();
    ...
    driver.findElement(By.id("inputCittà")).click();
    driver.findElement(By.id("inputCittà")).clear();
    driver.findElement(By.id("inputCittà")).sendKeys("marigliano");
    driver.findElement(By.id("inputCap")).click();
    driver.findElement(By.id("inputCap")).clear();
    driver.findElement(By.id("inputCap")).sendKeys("80034");
    driver.findElement(By.id("inputTelefono")).click();
    driver.findElement(By.id("inputTelefono")).clear();
    driver.findElement(By.id("inputTelefono")).sendKeys("0818412205");
