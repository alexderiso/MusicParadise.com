...
public class TC_4_1_5 {
  ...
  @Test
  public void testTC415() throws Exception {
    driver.get("http://localhost:8080/ProgettoIS/index.jsp");
    driver.findElement(By.cssSelector("div.intro-header.jquery4")).click();
    ...
    driver.findElement(By.id("inputCittà")).sendKeys("dsa");
