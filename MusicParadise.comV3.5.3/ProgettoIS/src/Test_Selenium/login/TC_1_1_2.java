...
public class TC_1_1_2 {
  ...
  public void testTC112() throws Exception {
    ...
    driver.findElement(By.id("inputNick")).sendKeys("antonio");
    driver.findElement(By.id("inputPassword")).click();
    driver.findElement(By.id("inputPassword")).clear();
    driver.findElement(By.id("inputPassword")).sendKeys("12");
    driver.findElement(By.cssSelector("input.btn.btn-default")).click();
    driver.findElement(By.xpath("//input[@value='annulla']")).click();
  }
