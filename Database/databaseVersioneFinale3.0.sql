...
CREATE TABLE `carta` (
  ...
  PRIMARY KEY (`cod`),
  KEY `fk1_idx` (`cliente`),
  CONSTRAINT `fk1` FOREIGN KEY (`cliente`) REFERENCES `cliente` (`nickname`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `carta` VALUES (4,'1/17','3456789012345678','Antonio Spera','antonio10');
...
INSERT INTO `cliente` VALUES ('a@gmail.com','antonio10','Antonio','Spera','12345678');
...
CREATE TABLE `composizione` (
  `prodotto` int(6) NOT NULL AUTO_INCREMENT,
  `ordine` int(11) NOT NULL,
  PRIMARY KEY (`prodotto`,`ordine`),
  KEY `prd_2_idx` (`ordine`),
  CONSTRAINT `prd_1` FOREIGN KEY (`prodotto`) REFERENCES `prodottoordine` (`codice`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `prd_2` FOREIGN KEY (`ordine`) REFERENCES `ordine` (`num_ordine`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `composizione` VALUES (15,13),(16,13);
...
CREATE TABLE `foto` (
  ...
  `codice_prodotto` int(6) DEFAULT NULL,
  `immagine` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`codice`),
  KEY `foto_ibfk_1_idx` (`codice_prodotto`),
...
INSERT INTO `foto` VALUES (0,0,'immaginiProdotti/yamaha_batteria.jpg'),(1,0,'immaginiProdotti/yamaha_batteria2.jpg'),(2,0,'immaginiProdotti/yamaha_batteria3.jpg'),(3,1,'immaginiProdotti/tamburo_batteria.jpg'),(4,1,'immaginiProdotti/tamburo_batteria1.jpg'),(5,1,'immaginiProdotti/tamburo_batteria2.jpg'),(6,2,'immaginiProdotti/chitarra_Yamaha.jpg'),(7,2,'immaginiProdotti/chitarra_Yamaha2.jpg'),(8,2,'immaginiProdotti/chitarra_Yamaha3.jpg'),(9,3,'immaginiProdotti/chitarra_Fender3.jpg'),(10,3,'immaginiProdotti/chitarra_Fender2.jpg'),(11,3,'immaginiProdotti/chitarra_Fender.jpg'),(12,4,'immaginiProdotti/basso_fender.jpg'),(13,4,'immaginiProdotti/basso_fender2.jpg'),(14,4,'immaginiProdotti/basso_fender3.jpg'),(15,5,'immaginiProdotti/amplificatore_marshall.jpg'),(16,5,'immaginiProdotti/amplificatore_marshall2.jpg'),(17,5,'immaginiProdotti/amplificatore_marshall3.jpg'),(18,6,'immaginiProdotti/basso_fender_m7_2.jpg'),(19,6,'immaginiProdotti/basso_fender_m7.jpg'),(20,6,'immaginiProdotti/basso_fender_m7_3.jpg'),(21,7,'immaginiProdotti/tastiera_yamaha.jpg'),(22,7,'immaginiProdotti/tastiera_yamaha2.jpg'),(23,7,'immaginiProdotti/tastiera_yamaha3.jpg'),(24,8,'immaginiProdotti/batteria_pearl2.jpg'),(25,8,'immaginiProdotti/batteria_pearl.jpg'),(26,8,'immaginiProdotti/batteria_pearl3.jpg'),(27,9,'immaginiProdotti/software_ableton2.jpg'),(28,9,'immaginiProdotti/software_ableton.jpg'),(29,9,'immaginiProdotti/software_ableton3.jpg'),(30,10,'immaginiProdotti/software_ableton_educational2.jpg'),(31,10,'immaginiProdotti/software_ableton_educational.jpg'),(32,10,'immaginiProdotti/software_ableton_educational3.jpg'),(33,11,'immaginiProdotti/software_sony.jpg'),(34,11,'immaginiProdotti/software_sony2.jpg'),(35,11,'immaginiProdotti/software_sony3.jpg'),(36,12,'immaginiProdotti/software_cubase.jpg'),(37,12,'immaginiProdotti/software_cubase2.jpg'),(38,12,'immaginiProdotti/software_cubase3.jpg'),(39,13,'immaginiProdotti/amplificatore_fbt.jpg'),(40,13,'immaginiProdotti/amplificatore_fbt2.jpg'),(41,13,'immaginiProdotti/amplificatore_fbt3.jpg'),(42,14,'immaginiProdotti/amplificatore_jbl3.jpg'),(43,14,'immaginiProdotti/amplificatore_jbl2.jpg'),(44,14,'immaginiProdotti/amplificatore_jbl.jpg'),(45,15,'immaginiProdotti/tastiera_yamahaP115-3.jpg'),(46,15,'immaginiProdotti/tastiera_yamahaP115.jpg'),(47,15,'immaginiProdotti/tastiera_yamahaP115-2.jpg'),(48,16,'immaginiProdotti/accessori_evans3.jpg'),(49,16,'immaginiProdotti/accessori_evans2.jpg'),(50,16,'immaginiProdotti/accessori_evans.jpg'),(51,17,'immaginiProdotti/accessori_evans_RealFeel.jpg'),(52,17,'immaginiProdotti/accessori_evans_RealFeel2.jpg'),(53,17,'immaginiProdotti/accessori_evans_RealFeel3.jpg'),(54,18,'immaginiProdotti/pianoforte_yamaha.jpg'),(55,18,'immaginiProdotti/pianoforte_yamaha2.jpg'),(56,18,'immaginiProdotti/pianoforte_yamaha3.jpg'),(57,19,'immaginiProdotti/dj_pioneer3.jpg'),(58,19,'immaginiProdotti/dj_pioneer.jpg'),(59,19,'immaginiProdotti/dj_pioneer2.jpg'),(60,20,'immaginiProdotti/dj_pioneer_DDJRB1.jpg'),(61,20,'immaginiProdotti/dj_pioneer_DDJRB2.jpg'),(62,20,'immaginiProdotti/dj_pioneer_DDJRB3.jpg'),(63,21,'immaginiProdotti/tastiera_akai.jpg'),(64,21,'immaginiProdotti/tastiera_akai2.jpg'),(65,21,'immaginiProdotti/tastiera_akai3.jpg'),(66,22,'immaginiProdotti/sax_yamaha.jpg'),(67,22,'immaginiProdotti/sax_yamaha2.jpg'),(68,22,'immaginiProdotti/sax_yamaha3.jpg'),(69,23,'immaginiProdotti/homeRecording_pioneer.jpg'),(70,23,'immaginiProdotti/homeRecording_pioneer2.jpg'),(71,23,'immaginiProdotti/homeRecording_pioneer3.jpg'),(72,24,'immaginiProdotti/homeRecording_yamaha.jpg'),(73,24,'immaginiProdotti/homeRecording_yamaha2.jpg'),(74,24,'immaginiProdotti/homeRecording_yamaha3.jpg'),(75,25,'immaginiProdotti/sax_yamahaYTS280.jpg'),(76,25,'immaginiProdotti/sax_yamahaYTS280-2.jpg'),(77,25,'immaginiProdotti/sax_yamahaYTS280-3.jpg'),(78,26,'immaginiProdotti/tromba_yamaha.jpg'),(79,26,'immaginiProdotti/tromba_yamaha2.jpg'),(80,26,'immaginiProdotti/tromba_yamaha3.jpg'),(81,27,'immaginiProdotti/tastiera_casio.jpg'),(82,27,'immaginiProdotti/tastiera_casio2.jpg'),(83,27,'immaginiProdotti/tastiera_casio3.jpg'),(84,28,'immaginiProdotti/accessorio_apple.jpg'),(85,28,'immaginiProdotti/accessorio_apple2.jpg'),(86,28,'immaginiProdotti/accessorio_apple3.jpg'),(87,29,'immaginiProdotti/amplificatore_fbtSTAGEMAX12MA.jpg'),(88,29,'immaginiProdotti/amplificatore_fbtSTAGEMAX12MA2.jpg'),(89,29,'immaginiProdotti/amplificatore_fbtSTAGEMAX12MA3.jpg'),(90,30,'immaginiProdotti/dj_akai.jpg'),(91,30,'immaginiProdotti/dj_akai2.jpg'),(92,30,'immaginiProdotti/dj_akai3.jpg'),(93,31,'immaginiProdotti/batteria_pearlEXL725.jpg'),(94,31,'immaginiProdotti/batteria_pearlEXL725-2.jpg'),(95,31,'immaginiProdotti/batteria_pearlEXL725-3.jpg'),(96,32,'immaginiProdotti/batteria_pearlEXX725SP.jpg'),(97,32,'immaginiProdotti/batteria_pearlEXX725SP-2.jpg'),(98,32,'immaginiProdotti/batteria_pearlEXX725SP-3.jpg');
...
CREATE TABLE `incarrello` (
  `prodotto` int(6) NOT NULL,
  `utente` varchar(30) NOT NULL,
  `quantita` int(11) NOT NULL,
  PRIMARY KEY (`prodotto`,`utente`),
  CONSTRAINT `carrello_1` FOREIGN KEY (`prodotto`) REFERENCES `prodottoincatalogo` (`codice`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `indirizzo` VALUES (1,'Via Napoli','Marigliano','80034','Antonio','Spera','0818412205','antonio10');
...
CREATE TABLE `ordine` (
  `utente` varchar(30) NOT NULL,
  `num_ordine` int(11) NOT NULL AUTO_INCREMENT,
  `data_ordine` date NOT NULL,
  `totale` decimal(10,2) NOT NULL,
  `indirizzo` int(6) NOT NULL,
  `carta` int(6) NOT NULL,
  ...
  KEY `ordine_ibfk_2_idx` (`carta`),
  KEY `ordine_ibfk_3_idx` (`indirizzo`),
  CONSTRAINT `ordine_ibfk_1` FOREIGN KEY (`utente`) REFERENCES `cliente` (`nickname`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `ordine_ibfk_2` FOREIGN KEY (`carta`) REFERENCES `carta` (`cod`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `ordine_ibfk_3` FOREIGN KEY (`indirizzo`) REFERENCES `indirizzo` (`codice`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `ordine` VALUES ('antonio10',13,'2018-01-25',4796.18,1,4,'in preparazione','','',NULL);
...
CREATE TABLE `prodottoincatalogo` (
  `codice` int(6) NOT NULL,
  `num_disponibilità` int(11) NOT NULL,
...
INSERT INTO `prodottoordine` VALUES (9,1,'FENDER SQUIER JAZZ BASS AFFINITY V RW BLACK','Nero','FENDER','Rappresentando i migliori valori nel design di un basso sul mercato al giorno d\'oggi, i Jazz Bass V della serie Affinity hanno un tono potente e un feel veloce.',1.00,345.00,'Basso'),(10,1,'YAMAHA C40M SATINATA','Marrone chiaro','YAMAHA','Spendere poco ormai non vuol dire più accontentarsi di uno strumento di seconda scelta, come la C40 abilmente dimostra. ',1.00,115.00,'Chitarra'),(11,1,'YAMAHA YAS480','Oro','YAMAHA','SASSOFONO CONTRALTO IN MIb LACCATO ORO',3.00,1699.00,'Fiati'),(12,1,'MARSHALL JMD501','Nero','MARSHALL','MARSHALL JMD-1 JMD501 Combo Valvolare per Chitarra 50W 1x12\"',5.00,450.00,'Amplificatore'),(13,1,'ABLETON Live 9 Intro ','','ABLETON','Ableton Live 9 getta un ponte tra studio e palco con un flusso di lavoro intuitivo che ti permette di fare quasi tutto in tempo reale. ',1.00,79.00,'Software'),(14,1,'APPLE MD464ZM','Bianco','APPLE','Con l\'adattatore Apple da Thunderbolt a FireWire Apple colleghi facilmente il tuo dispositivo Apple con porta Thunderbolt a un dispositivo FireWire. Piccolo e compatto, si collega alla porta Thunderbolt del dispositivo e la trasforma in una porta FireWire 800: hai fino a 7W per utilizzare periferiche alimentate via bus come dischi rigidi e dispositivi audio.',1.00,34.90,'Accessori'),(15,1,'YAMAHA Tyros 5 76 ','Grigio','YAMAHA','Tyros è una tastiera caratterizzata dalle performance migliori, con suoni, effetti e accompagnamenti sorprendenti e così realistici da sembrare di essere accompagnati dai migliori musicisti al mondo. Tyros5 conferisce un nuovo livello di realismo al suono come nessun altro strumento prima d\'ora. E\' la compagna perfetta per abbozzare composizioni, realizzare l\'arrangiamento perfetto o eseguire performance memorabili.',1.00,3770.00,'Tastiere'),(16,1,'SONY Acid Pro 7','','SONY','Nel mondo della creazione musicale digitale, il software ACID Pro è sempre emerso come qualcosa di totalmente differente. La sua tecnologia di adattamento dei loop, sia al tempo che alla tonalità del progetto non è seconda a nessuna, e le sue funzionalità permettono di \"spalmare\" i loop sulle tracce e di \"dipingere\" la struttura del nostro brano con pochi e semplici gesti.',1.00,149.00,'Software');
...
-- Dump completed on 2018-01-25 23:58:05
